...
The models were tested using the **test split** of a custom Freesound-based dataset. Evaluation metrics included:
...
- Consider combining the models using a voting or ranking system.
- For example:
  - If **both models agree** it’s speech → accept as speech
  - If **Silero says non-speech**, trust its filtering
- Tune thresholds or experiment with segment-level analysis to improve performance.
